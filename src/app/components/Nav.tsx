    ...
    <nav>
      <ul>
        <li className={activeSection === 'moon-intro' ? 'active' : ''}>
          <Link href="#moon-intro"><img src='assets/images/moon-nav.png' alt='Moon Intro' /></Link>
        </li>
        <li className={activeSection === 'moon-terrain' ? 'active' : ''}>
          <Link href="#moon-terrain"><img src='assets/images/moon-nav.png' alt='Moon Terrain' /></Link>
        </li>
        <li className={activeSection === 'moon-card' ? 'active' : ''}>
          <Link href="#moon-card"><img src='assets/images/moon-nav.png' alt='Moon Card' /></Link>
        </li>
